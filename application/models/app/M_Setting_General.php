...
class M_Setting_General extends CI_Model
{
	...
	{	
        $this->db->where('id', $id);
    	$this->db->delete('tb_bank_account');
	}

	function cont_trans($id)
	{	
        $this->db->where('id', $id);
    	$this->db->delete('tb_user_contacts');
	}

	function cont_update($data, $id)
	{	
		$this->db->where('id', $id);
        $this->db->update('tb_user_contacts', $data);
	}

	function update($data, $id)
	{	
		$this->db->where('id', $id);
        $this->db->update('tb_bank_account', $data);
	}
	...
	function containsert($data)
	{	
        $this->db->insert('tb_user_contacts', $data);
	}
	
	function get_confirm($id)
	{	
        $this->db->where('id', $id);
    	return $this->db->get('tb_user_contacts')->row_array();
	}
	function get_confirm_id()
	{	
	...
	{	
        $this->db->where('id', $id);
    	return $this->db->get('tb_bank_account')->row_array();
	}
	...
	// function not_in($data)
	// {	
    //     $this->db->where_not_in('type', $data);
    // 	return $this->db->get('tb_bank_account')->row_array();
	// }
