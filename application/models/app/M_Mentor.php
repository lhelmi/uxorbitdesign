...
class M_Mentor extends CI_Model
{
    ...
    public function data_table(){
        ...
        $this->datatables->select('
            ...
            status
            ');
        $this->datatables->where('grade', 'Instructor');
        ...
        $this->datatables->edit_column('username', '
            <div class="o-media">
                ...
                <div class="o-media__body">
                    $5
                    <span class="u-ml-xsmall c-badge c-badge--xsmall c-badge--success">Mentor</span>
                    <small class="u-block u-text-mute">
                        $2 ($3)
                    </small>
                </div>
            </div>
            ', 'photo_user(photo),username,email,grade_user(grade), nama_lengkap');

        $this->datatables->add_column('alat', '
            <a class="c-btn--custom c-btn--small c-btn c-btn--info" href="'.base_url('app/mentor/').'update/$1"><i class="fa fa-edit"></i></a>
            <button data-title="are you sure ?" data-text="want to delete $2" class="c-btn--custom c-btn--small c-btn c-btn--danger action-delete" data-id="$1" data-href="'. base_url('app/mentor/delete/$1') .'" type="button"><i class="fa fa-trash"></i></button>
            ', 'id,username');   
