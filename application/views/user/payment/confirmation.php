			...
			<div class="col-12 col-xl-6 offset-xl-3">
								...
								<tbody class="c-table__head">
									<tr class="c-table__row">
										<td class="c-table__cell c-table__cell--head u-text-center" colspan="2">
											<img src="<?php echo base_url('storage/assets/user/img/' . $val['type'] . '.png') ?>" alt="transaction">
										</td>
									</tr>
									<tr class="c-table__row">
				...
				<div class="c-card u-p-medium u-mb-small">
					...
					<div class="form-group">
						...
						<input name="sender" class="form-control" type="text" value="">
					...
					<div class="c-field u-mb-small">
						...
						<button class="btn btn-primary-orbit c-btn--fullwidth">
