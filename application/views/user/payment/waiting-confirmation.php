...
<div class="o-page__card">
	...
	<div class="u-text-center">
		<a href="<?php echo base_url() ?>" class="u-block u-mb-medium">
			<img src="<?php echo base_url('storage/assets/lms/default-app/img/logo for web.png') ?>" alt="<?php echo $site['title'] ?>" style="width: 120px;">
		</a>
		...
		<a class="btn btn-primary-orbit" href="<?php echo base_url('user/order') ?>">
					...
					<tbody class="c-table__head">
						<tr class="c-table__row">
							<td class="c-table__cell c-table__cell--head u-text-center" colspan="2">
								<img width="100px" src="<?php echo base_url('storage/assets/user/img/'. $read['medium']. '.png') ?>" alt="transaction">
							</td>
						</tr>
						<tr class="c-table__row">
							<td class="u-border-right u-pv-xsmall u-ph-small u-text-left">
								<?php echo $read['medium']; ?>
							</td>
							<td class="u-border-right u-pv-xsmall u-ph-small u-text-left">
