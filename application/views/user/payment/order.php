				...
				<div class="c-card u-p-small u-mb-small">
					...
					<article class="c-stage u-mb-zero" id="stages">
						<div class="row">
							<div class="col-md-4">
								<div class="card">
									<div title="<?php echo $courses['title'] ?>" class="u-color-primary">
										<img class="card-img-top" width="200" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 3 2'%3E%3C/svg%3E" data-src="<?php echo $courses['image']['thumbnail'] ?>" alt="<?php echo $courses['title'] ?>">
									</div>
								</div>
							</div>
							<div class="col-md-8">
								<div class="u-mv-small">
									<div title="<?php echo $courses['title'] ?>" class="h5 font-color-hitam u-text-bold">
		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-xl-8 offset-xl-2 u-pv-xsmall">
					...
					<div class="row">
						<div class="col-3 col-lg-3 c-toolbar__state">
						...
						<div class="col-3 col-lg-3 c-toolbar__state">
							<span class="c-toolbar__state-title font-color-green">
								<?php echo $this->lang->line('discount'); ?>
							</span>
							<h4 class="c-toolbar__state-number u-h4 font-color-green-bold">
						...
						<div class="col-3 col-lg-3 c-toolbar__state">
							<div class="c-toolbar__state-number u-h4 font-color-black">
								<?php echo $this->lang->line('total_price'); ?>
								<div id='order-price-total' class="u-block font-color-black-bold" data-price-total='<?php echo $courses['price_total'] ?>'>
