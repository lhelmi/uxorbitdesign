    ...
    <div class="col-12 col-lg-10 col-xl-8">
        <div class="row">
            ...
            <div class="col-6 col-md-6 c-toolbar__state">
                ...
                <span class="c-toolbar__state-title">Jumlah Total Invoice</span>
            </div>
        </div><!-- // .row -->
    </div><!-- // -->
</div>
        ...
        <div class="c-card__body">
            ...
            <form id='form-multiple' action="<?php echo base_url('app/user_invoice_history/process_multiple') ?>" method="post">
                ...
                <div class="c-table-responsive">
                    <table data-mysearch="Search..." data-myorder='5' data-myurl="<?php echo base_url('app/user_invoice_history/datatables') ?>" class="table table-striped" id="table">
                        ...
                        <thead class="c-table__head c-table__head--slim">
                            <tr class="c-table__row">
                                ...
                                <th class="c-table__cell c-table__cell--head all">Kode Pembayaran</th>
                                ...
                                <th class="c-table__cell c-table__cell--head all">Harga Kelas</th>
                                <th class="c-table__cell c-table__cell--head all">Waktu Pembayaran</th>
