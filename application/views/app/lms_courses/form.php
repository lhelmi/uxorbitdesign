...
<div class="col-12 u-mv-small">
    <div class="c-tabs">
        ...
        <ul class="c-tabs__list c-tabs__list--splitted nav nav-tabs" role="tablist">
            ...
            <?php if (!empty($data)) : ?>
                <li class="c-tabs__item"><a id='tab-material' class="c-tabs__link u-pv-xsmall u-ph-small u-text-small <?php echo (!empty($this->input->get('tab')) and $this->input->get('tab') == 'material') ? 'active show' : '' ?>" id="nav-material-tab" data-toggle="tab" href="#nav-material" role="tab" aria-controls="nav-material" aria-selected="false">Silabus</a></li>
            <?php endif ?>
        </ul>
