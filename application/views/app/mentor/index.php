...
<div class="col-12 u-mv-small">
    ...
    <div class="c-card c-card--responsive h-100vh u-p-zero">
        <div class="c-card__header c-card__header--transparent o-line">
            <a class="c-btn--custom c-btn--small c-btn c-btn--success" href="<?php echo base_url('app/mentor/create') ?>">
        ...
        <div class="c-card__body">
            ...
            <form id='form-multiple' action="<?php echo base_url('app/mentor/process_multiple') ?>" method="post">

                <div class="c-table-responsive">
                    <table data-mysearch="Search..." data-myorder='1' data-myurl="<?php echo base_url('app/mentor/datatables') ?>" class="c-table c-table--highlight u-hidden" id="table">
