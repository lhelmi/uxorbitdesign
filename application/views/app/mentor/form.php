                ...
                <div class="c-card__body">   
                    ...
                    <div class="u-text-center u-mb-medium">
                        <div class="c-avatar c-avatar--xlarge u-inline-block">
                            <img class="c-avatar__img" src="<?php echo (!empty($user['photo']) ?  base_url('storage/uploads/mentor/photo/'.$user['photo']) : base_url('storage/uploads/mentor/photo/default.png')) ?>" alt="<?php echo $this->session->userdata('username') ?>">
                        </div>
                    ...
                    <div class="c-field u-mb-small">
                        ...
                        <input required="" name="nama_lengkap" class="c-input" type="text" value="<?php echo (!empty($user['nama_lengkap'])) ? (!empty(set_value('nama_lengkap')) ? set_value('nama_lengkap') : $user['nama_lengkap'] ) : set_value('nama_lengkap') ?>"/>
