...
<div class="container-fluid mt-100">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <a href="<?= site_url('courses-lesson/'.$e_type.'/'. $get_byid['tb_lms_courses_section_id'] .'/'.$get_byid['tb_lms_courses_lesson_id']) ?>" class="badge badge-primary" aria-pressed="true">
    ...
    <form id="balas" action="<?= site_url('pertanyaan'); ?>" method="POST">
        <input type="hidden" value="<?= $id ?>" name="id" id="id">
        <input type="hidden" value="<?= $idless ?>" name="idless" id="idless">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="media flex-wrap w-100 align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <?= $vv['username'] ?>
                                <?php if($vv['grade'] == 'Instructor'){ ?>
                                <span class="badge badge-primary"><?= $vv['grade']; ?></span>
                                <?php } ?>
                                <div class="text-muted small">
