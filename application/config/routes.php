...
// $route['courses-lesson/(:any)'] = 'lms/Courses/certificate/$1';
...
$route['lms/forum(.*)'] = 'My_error'; 
$route['add-Forum/(:any)'] = 'lms/Forum/add/$1';
$route['Forum/(:any)'] = 'lms/Forum/index/$1';
$route['pertanyaan'] = 'lms/Forum/add_comment/';
$route['pertanyaan/(:any)/(:any)'] = 'lms/Forum/detail/$1/$2';

$route['forum/detail/(:any)'] = 'app/user_forum/detail/$1';
