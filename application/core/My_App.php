...
class My_App extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        if ($this->session->userdata('app_grade') == 'Instructor') {
            if ($this->uri->segment(2) === 'user_tfrequest' OR $this->uri->segment(2) === 'user_submisi' OR $this->uri->segment(2) === 'user_forum' OR $this->uri->segment(2) === 'lms_courses' OR $this->uri->segment(2) === 'user_invoice' OR $this->uri->segment(2) === 'user_invoice_history' OR $this->uri->segment(2) === 'setting_payment' OR $this->uri->segment(2) === 'user_setting') {
