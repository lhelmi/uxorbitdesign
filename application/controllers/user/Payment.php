...
class Payment extends My_User
{
    ...
    public function order($slug = false)
    {
        ...
        'widget' => $widget,    
        'courses' =>  $courses,
        'get_bank' => $get_bank = $this->M_Payment->get_user_bank(),
        ];
    ...
    public function waiting_confirmation($id_order){
        ...
        $confirm = $this->M_Payment_Confirmation->confirm();
    ...
    public function confirmation($id_order){
        ...
        if($this->form_validation->run() != false){
            ...
            $get_token = $this->M_Setting_Payment->get_token($id_order);
            // $get_bank = $this->M_Setting_Payment->get_bank($get_token['token']);
            ...
            $data = [
                ...
                'get_bank' => $this->M_Setting_Payment->get_bank($get_token['token']),
                'get_confirm' => $this->M_Setting_Payment->get_confirm($id_order),
            ];
